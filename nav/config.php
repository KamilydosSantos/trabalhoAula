...
<head>
    ...
    <script src="../js/selectThema.js"></script>
...
<body>
    ...
    <div class="panelConfig">
        <buttom onclick="tema01()" class="boxConfig" id="button">
            <img src="../images/tema01.png">
        </buttom>
        <buttom class="boxConfig">
            <img onclick="tema02()" src="../images/tema01.png">
        </buttom>
        <buttom class="boxConfig">
            <img onclick="tema03()" src="../images/tema01.png">
        </buttom>
    </div>
</body>
</html>